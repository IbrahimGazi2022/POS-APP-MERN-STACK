...
// Selected Categories Function 
{
    ...
    //     // homePage.js
    //     const [selectedCategory, setSelectedCategory] = useState("ami jeta default dekhate chai");

    //     const categories = [
    //         {
    //             name: "masalaName",
    //             imageURL: "image er url"
    //         },
    //         {
    //             name: "masalaName",
    //             imageURL: "image er url"
    ...
    //     <div className="display flex kore dite hbe">
    ...
    //                 </div>
    //                 // css joto tuku dorkar kore nite hbe
    //             );
    //         })}
    //     </div>;

    //     // er pore 
    //     <div className={` ${selectedCategory} === category.name && 'selected-category'}`}>
    //         <h4>{category.name}</h4>
    //         <img src={category.imageURL} height="60" width="60" />
    //     </div>;
